...
export class LoginComponent implements OnInit {
  ...
  //Bueno vamos a ver, tu aquí empiezas y todo bien todo normal
  login() {
    ...
    this.usuarioService.login( this.loginForm.value)
      .subscribe( res => {
        ...
        //Al ser cliente una coleccion a parte, hay que ir por otro camino, y se lia la cosa
        //Esto no funciona la vd
        else{
          // this.clienteService.login( this.loginForm.value)
          // .subscribe( res => {
          //   if (this.loginForm.get('remember').value) {
          //     localStorage.setItem('email', this.loginForm.get('email').value);
          //   } else {
