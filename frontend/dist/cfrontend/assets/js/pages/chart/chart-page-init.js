...
const linesChart = (gratis, estandar, premium, listaMeses, listaMesesClientes) => {
    ...
    $(function() {
        ...
        var mes_cliente = fecha.getMonth();



        //Ordenando FISIOS por meses
        for (let i = 6; i > 0; i--) {
            d1.push([i, (listaMeses[mes])]);
            mes--;

            //Cambiar mes de 0 a 11
            if (mes < 0) {
                mes = 11;
            }
        }

        //Ordenando CLIENTES por meses
        for (let i = 6; i > 0; i--) {
            d2.push([i, (listaMesesClientes[mes_cliente])]);
            mes_cliente--;
        ...
        //GRAFICA DE CLIENTES, CUANDO ESTEN LOS DATOS
        // d2.push([0, 0]);
        // d2.push([1, 0]);
        // d2.push([2, 0]);
        // d2.push([3, 0]);
