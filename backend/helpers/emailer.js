...
const sendMail = async(email, id, fisionom, clientenom) => {
    const transporter = createTrans();
    const base_url = 'http://localhost:4200/cliente/newpass';
    const base_url_prod = 'https://mykine.ovh/cliente/newpass';
...
<table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tr style="border-collapse:collapse">
<td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:15px"><h3 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333">Hola Cliente <strong>${clientenom}</strong>,</h3></td>
</tr>
<tr style="border-collapse:collapse">
<td align="left" style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">¡Bienvenido! Has sido registrado con éxito por tu fisio <strong>${fisionom}</strong></p></td>
</tr>
<tr style="border-collapse:collapse">
...
module.exports = { createTrans, sendMail }