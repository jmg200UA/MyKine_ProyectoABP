...
const { obtenerEjercicios, obtenerEjerciciosNoPag, crearEjercicio, actualizarEjercicio, eliminarEjercicio } = require('../controllers/ejercicios');
...
router.post('/', [
    ...
    check('subtipo', 'El argumento subtipo es obligatorio').not().isEmpty().trim(),
    validarCampos,
    validarRolAdmin,
], crearEjercicio);
